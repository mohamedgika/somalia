                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="name" value="{{ $ad->name }}" type="text" id="name"
                                    class="form-control">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="price" value="{{ $ad->price }}" type="text" id="price"
                                    class="form-control">
                                @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="country" value="{{ $ad->country }}" type="text" id="country"
                                    class="form-control">
                                @error('name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="state" value="{{ $ad->state }}" type="text" id="state"
                                    class="form-control">
                                @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="city" value="{{ $ad->city }}" type="text" id="city"
                                    class="form-control">
                                @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
